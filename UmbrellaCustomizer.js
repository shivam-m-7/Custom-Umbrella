...
const umbrellas = {
  blue: {
    image: "./assets/Blue_umbrella.png",
    color: "#34B5E5",
    backgroundColor: "rgba(52, 181, 229, 0.3)",
  },
  yellow: {
    image: "./assets/Yellow_umbrella.png",
    color: "#FED34E",
    backgroundColor: "rgba(254, 211, 78,0.3)",
  },
  pink: {
    image: "./assets/Pink_umbrella.png",
    color: "#D9378D",
...
// UpLoadernkfjnrgkjefngkernkgjberigbreibgeiuberbiber
  showLoading(() => {
    ...
    fileReader.addEventListener("load", () => {
      logoContainer.innerHTML = `<img src=${fileReader.result} alt"upload-image" style="display : inline-block; height: 60%; width:60%"/>`;
      uploadIcon.src = "./assets/upload_icon.svg";
    });
